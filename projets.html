        ...
        <main class="container">
            <div class="projets">
                <div class="projets__article">
                        ...
                        <a href="article.html" class="projets__link">
                            ...
                            <div class="projets__hov">
                                <div class="projets__title">
                                    ...
                                    <a href="article.html" class="projets__text-two">Voir le projet</a>
                                </div>
                    ...
                    <div class="projets__content">
                        <a href="article.html" class="projets__link">
                            <img src="img/baobab.jpg" class="projets__image" width="2250" height="1500" alt="Le projet du site Baobab"/>
                            <div class="projets__hov">
                                <div class="projets__title">
                                    <p class="projets__text-one">
                                        Le projet du site de Baobab
                                    </p>
                                    <a href="article.html" class="projets__text-two">Voir le projet</a>                                    </div>
                                <div class="projets__color"></div>
                            </div>
                        </a>
                    </div>
                    <div class="projets__content">
                        <a href="article.html" class="projets__link">
                            <img src="img/biblio.jpg" class="projets__image" width="2360" height="1598" alt="Un gestionnaire de bibliothèque"/>
                            <div class="projets__hov">
                                <div class="projets__title">
                                    <p class="projets__text-one">
