    ...
    <div class="container__article">
        ...
        <div class="container__site">
            <figure class="container__figure">
                <img src="<?php the_field('article_site');?>" class="container__site-picture"alt="Site de Baobab" width="1285" height="838"/>
            </figure>
            <div class="container__info">
                ...
                <a href="#" class="container__site-link"><?php _e('Vers le site','b');?></a>
            </div>
        </div>
